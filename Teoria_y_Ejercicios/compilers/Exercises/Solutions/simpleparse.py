...
if __name__ == '__main__':
    ...
    print('value left:', result.value.left.value)
    print('value right:', result.value.right)
    print('value right left:', result.value.right.left)
    print('value right right:', result.value.right.right)
    '''
    print(result)